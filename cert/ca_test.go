...
func TestCertCreation(t *testing.T) {
	...
	"signatures": [
		...
		{
			"protected": "",
			"header": {
				"sig_type": "cos"
			},
			"signature": "P_JwaPD7VHNPq5WQADYu7EhO0poz-U-njw__z-swr1LzAr1R1uiJImzuVgL-TNCWelUygsCSoYCDGmR_rUXVYg"
		}
	]
}`)
